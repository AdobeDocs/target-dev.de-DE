...
description: Stellen Sie sicher, dass alle erforderlichen Schritte zum Laden des Adobe Experience Platform Web SDK in der richtigen Reihenfolge ausgeführt werden.
feature: APIs/SDKs
level: Experienced
role: Developer
hide: true
...
![SDK-Diagramm initialisieren](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![Besucher-API-SDK-Diagramm laden](/help/dev/patterns/assets/load-visitor-api-sdk.png){width="100" zoomable="yes"}
...
* Sie benötigen die `VisitorAPI.js` -Datei. Wenden Sie sich an Ihr Digital Marketing-Team, um diese Datei zu erhalten.
...
![Kunden-ID festlegen](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![Automatische Seitenladeanforderung konfigurieren](/help/dev/patterns/assets/configure-automatic-page-request.png){width="100" zoomable="yes"}
...
![Flackern-Handling-Diagramm konfigurieren](/help/dev/patterns/assets/flicker-handling.png){width="100" zoomable="yes"}
...
![Datenzuordnungsdiagramm](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![Diagramm zur Remote-Datenzuordnung](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
...
![Adobe Target Web SDK-Diagramm laden](/help/dev/patterns/assets/load-web-sdk.png){width="100" zoomable="yes"}

**Voraussetzungen**

* Laden Sie die Web SDK-Bibliotheksdatei herunter oder fragen Sie sie bei Ihrem Digital Marketing-Team: `at.js 2.*x*`
