...
title: Wie integriere ich Daten in  [!DNL Target]  mit der [!UICONTROL API zur Aktualisierung einzelner Profile]?
...
# [!UICONTROL API zur Aktualisierung von einzelnen Profilen]
...
Vergleichen Sie die [!UICONTROL API zur Einzelprofil-Aktualisierung] mit der [[!DNL Adobe Target Single Profile Update API]](/help/dev/administer/profile-api/profile-single-api.md).
