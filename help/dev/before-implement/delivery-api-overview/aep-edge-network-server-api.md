...
Weitere Informationen finden Sie unter [Übersicht über die Edge Network](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html){target=_blank}Server-API in der Dokumentation zur Edge-Server-API *.*
