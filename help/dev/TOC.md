...
+ Client-seitige Implementierung {#client-side}
   ...
   + Adobe Experience Platform Web SDK-Implementierung {#aep}
      ...
      + [Implementieren von Einzelseiten-Apps](/help/dev/implement/client-side/aep-web-sdk/spa-implementation.md)
      + [Zugriffs-Antwort-Token](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [mbox3rdPartyId verwenden](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
      + [Vergleichen der at.js-Bibliothek mit der Platform Web SDK](/help/dev/implement/client-side/aep-web-sdk/web-sdk-atjs-comparison.md)
   + at.js-Implementierung {#at-js-implementation}
      + Funktionsweise von „at.js“ {#at-js}
         + [Übersicht über die at.js-JavaScript-Bibliothek](/help/dev/implement/client-side/atjs/how-atjs-works/overview.md)
         + [Übersicht über at.js-Arbeiten](/help/dev/implement/client-side/atjs/how-atjs-works/how-atjs-works.md)
         + [Verwaltung von Flackern mit „at.js“](/help/dev/implement/client-side/atjs/how-atjs-works/manage-flicker-with-atjs.md)
         + [„at.js“-Integrationen](/help/dev/implement/client-side/atjs/how-atjs-works/target-atjs-integrations.md)
...
+ Analytics for Target (A4T) mit Experience Platform SDK {#a4t}
   + [Protokollierung von Adobe Analytics for Target (A4T) in Experience Platform Web SDK](/help/dev/implement/a4t/overview-a4t.md)
...
+ [hide-from-tocRecommendations-Implementierung - Betaversion](/help/dev/implement/recommendations/recommendations-beta.md)
