...
+ Clientseitige Implementierung {#client-side}
   + [Übersicht: Target für Client-seitiges Web implementieren](implement/client-side/overview.md)
   + [Übersicht über die Implementierung des Adobe Experience Platform Web SDK](implement/client-side/aep-web-sdk.md)
   ...
   + [Benutzer-Agent- und Client-Hinweise](implement/client-side/atjs/user-agent-and-client-hints.md)
...
+ Serverseitige Implementierung {#server-side}
   ...
   + [Beispielanwendungen](implement/server-side/sdk-guides/sample-apps/sample-apps.md)
   ...
   + Grundprinzipien {#core-principles}
      ...
      + [Benutzer-ID und -Bucket](implement/server-side/sdk-guides/core-principles/user-identification-and-bucketing.md)
   ...
   + On-Device Decisioning {#on-device-decisioning}
      ...
      + Regelartefakt {#rule-artifact}
         ...
         + [Beispielregel-Artefakt](implement/server-side/sdk-guides/on-device-decisioning/rule-artifact-example.md)
      + [Durchführen von A/B-Tests mit Funktionsmarkierungen](implement/server-side/sdk-guides/on-device-decisioning/execute-ab-tests-with-feature-flags.md)
      ...
      + [Übersicht über unterstützte Funktionen](implement/server-side/sdk-guides/on-device-decisioning/supported-features.md)
      + [Fehlerbehebung bei Entscheidungen auf dem Gerät](implement/server-side/sdk-guides/on-device-decisioning/troubleshooting.md)
      + [Best Practices  ](implement/server-side/sdk-guides/best-practices/best-practices.md)
   + Node.js-SDK-Referenz {#node-js}
      + [Übersicht über das Node.js-SDK](implement/server-side/node-js/overview.md)
      + [Installieren des Node.js-SDK](implement/server-side/node-js/install-sdk.md)
      + [Initialisieren des Node.js-SDK](implement/server-side/node-js/initialize-sdk.md)
      + [Angebote abrufen (Node.js)](implement/server-side/node-js/get-offers.md)
      + [Abrufen von Attributen (Node.js)](implement/server-side/node-js/get-attributes.md)
      + [Benachrichtigungen senden (Node.js)](implement/server-side/node-js/send-notifications.md)
   ...
   + .NET SDK-Referenz {#net}
      + [.NET SDK - Übersicht](implement/server-side/net/overview.md)
      + [.Net SDK installieren](implement/server-side/net/install-sdk.md)
      + [Initialisieren des .NET SDK](implement/server-side/net/initialize-sdk.md)
   ...
   + Python SDK-Referenz {#python}
      + [Python SDK - Übersicht](implement/server-side/python/overview.md)
      + [Python SDK installieren](implement/server-side/python/install-sdk.md)
      + [Initialisieren des Python-SDK](implement/server-side/python/initialize-sdk.md)
      + [Angebote abrufen (Python)](implement/server-side/python/get-offers.md)
      + [Abrufen von Attributen (Python)](implement/server-side/python/get-attributes.md)
      ...
      + [Asynchrone Anforderungen (Python)](implement/server-side/python/asynchronous-requests.md)
...
+ Implementierung mobiler Apps {#mobile-apps}
   ...
   + Adobe Mobile SDK-Version 4.x {#version-4}
      + [Funktionsweise von Target in Apps](implement/mobile/how-target-works-mobile-apps.md)
      + [Aktivieren von Target im SDK](implement/mobile/enable-target-in-sdk.md)
      + [iOS – Erstellen von Target-Standorten und Erfolgsmetriken](implement/mobile/mobile-create-location-and-metric.md)
      + [iOS – Senden benutzerdefinierter Benutzerdaten](implement/mobile/mobile-custom-user-data.md)
      + [Vorabruf des Angebotsinhalts](implement/mobile/prefetch-offer-content.md)
...
+ API-Handbücher {#api}
   ...
   + Handbuch zur Bereitstellungs-API {#delivery-api}
      ...
      + [SDKs zur Interaktion mit der Bereitstellungs-API](/help/dev/before-implement/delivery-api-overview/sdks.md)
   ...
   + Modelle-API {#models-api}
      + [Übersicht über die Modelle-API (Auf die Blockierungsliste setz)](before-administer/models-api.md)
      + [Modelle-API](/help/dev/administer/models-api/models-api-overview.md)
...
+ Implementierungsmuster {#implementation-patterns} {#hidden}
   + [Übersicht über Implementierungsmuster](/help/dev/patterns/pattern-overview.md)
   + Target-Implementierungsmuster {#target}
      + [Initialisieren von SDKs](/help/dev/patterns/initialize-sdk.md)
      + [Datenerfassung konfigurieren](/help/dev/patterns/data-collection.md)
      + [Erlebnisse rendern](/help/dev/patterns/render-experiences.md)
      + [Target benachrichtigen](/help/dev/patterns/notify-target.md)
