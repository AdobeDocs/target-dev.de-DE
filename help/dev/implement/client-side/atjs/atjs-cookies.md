...
description: Details zum  [!DNL Adobe Target]  von at.js 2.x und at.js 1.x mit Cookies
title: at.js-Cookies
feature: at.js
...
| disable | Wird festgelegt, wenn die Ladezeit des Besuchers den in der Adobe Experience Platform Web SDK- oder at.js-Datei konfigurierten Timeout überschreitet. Standardmäßig ist dieser Wert eine Stunde gültig. |

## Auswirkungen auf die [!DNL Target] für Safari-Besucher aufgrund von Apple WebKit-Tracking-Änderungen

Berücksichtigen Sie Folgendes:

### Wie funktioniert [!DNL Adobe Target] Tracking?
