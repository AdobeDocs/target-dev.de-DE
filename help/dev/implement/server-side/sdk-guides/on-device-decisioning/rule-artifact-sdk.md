...
1. Sowohl die Client- als auch die Organisations-ID können aus [!DNL Adobe Target] abgerufen werden, indem Sie zu **[!UICONTROL Administration]** > **[!UICONTROL Implementierung]** navigieren, wie hier dargestellt.
