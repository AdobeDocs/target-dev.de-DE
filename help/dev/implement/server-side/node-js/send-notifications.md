...
Eine erfolgreiche Antwort enthält ein Antwortobjekt [!UICONTROL Target-Bereitstellungs-API], das vorab abgerufene Inhalte für die angeforderten Mboxes enthält. Ein Beispiel für ein `targetResponse.response` kann wie folgt aussehen:
